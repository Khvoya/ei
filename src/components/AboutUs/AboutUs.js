    ...
    <div id="band" className="AboutUs">
      ...
      <Col xl="6" lg="12" md="12" sm="12" xs="12" className="AboutUs__text">
        ...
        <p>
          ...
          which we unite in our music using an ambient transitions, african and
          jungle-beats, vocal performances with processor and looper etc. It's
          not capable of "sticking to the shore" of a particular style: the
          mood, the shade of genres and even language can vary from song to song
          withiout losing the spirit of rock and metal schools, of course. Also,
          using the work with lighting devices, any of our shows turns into a
          kind of "ritual", which will not leave indifferent any participant of
          the event..
        </p>
      </Col>
    </div>
